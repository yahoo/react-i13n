  ...
  grunt.initConfig({
    ...
    shell: {
      cover: {
        ...
        command:
          'NODE_ENV=test nyc --report-dir <%= project.coverage_dir %> --reporter lcov _mocha <%= project.unit %> --compilers js:babel-register --require babel-polyfill --recursive --reporter spec --timeout 10000'
      },
      unit: {
        command:
